...
| **03b** | `Step_03b_CarouselTemplates.md` | SCRL-style carousel mode | 18–22 | 🟡 In progress — slice 1 (stitcher + service + frame model) done, 8 tests green. See Step 03b notes below |
