...
| **03b** | `Step_03b_CarouselTemplates.md` | SCRL-style carousel mode | 18–22 | 🟡 In progress — slices 1–4 done (foundation, parser/20 templates, builders, editor VM + frame navigator UI). 109 unit+int + 12 UI green. Type selector / preview / export next. See Step 03b notes below |
