...
| **03a** | `Step_03a_StandardTemplates.md` | Frame/story template editor | 13–17 | 🟡 Slices 1–2 complete — foundation (`TemplateService` + `CanvasPreset` + zone typing) and the Template Gallery UI (canvas/category/search filtering, premium gate, Home entry, grid-template routing). 44 unit + 6 UI tests green. Template editor, text/sticker/freeform, and 30 template JSONs remain. See Step 03a notes below |
