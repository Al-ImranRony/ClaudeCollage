...
| **03b** | `Step_03b_CarouselTemplates.md` | SCRL-style carousel mode | 18–22 | 🟡 In progress — slices 1–3 done (foundation + parser/20 templates + builders), 97 unit+int green. Editor UI next. See Step 03b notes below |
